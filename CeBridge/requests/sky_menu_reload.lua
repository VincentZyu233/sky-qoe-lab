local dllPath = [[D:\Downloads\temp\.build\SkyQoEMenu-v040\SkyQoEMenu.dll]]
...
if version ~= 0x00040000 then
  return string.format('{"ok":false,"error":"unexpected menu version","version":%d}',
                       version or 0)
end

return string.format('{"ok":true,"pid":%d,"module":"0x%X","size":%d,"version":"0.4.0"}',
